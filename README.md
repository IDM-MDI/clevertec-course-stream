...
### Задача №16
```
В мире произошла вспышка эпидемии вируса которая распространяется только на животных до 30 лет.
Так же для статистики сформируйте группу животных по стране происхождения и среднему возрасту в этой стране. Из полученной
группы найдите страну с самыми пожилыми особями и отправьте эту информацию нам. Особи этой страны поможет нам с эпидемией. :D
```